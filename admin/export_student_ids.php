...
<div class="admin-layout">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="export_student_ids" class="sb-link active"><i class="fas fa-address-card"></i> Export Student IDs</a>
            ...
            <section class="dash-panel reveal d1">
                ...
                <div class="panel-body">
                    <form method="GET" class="filter-form">
                        ...
                        <a href="export_student_ids" class="notion-btn notion-btn-ghost notion-btn-sm">Clear</a>
                        <?php if ($classId > 0): ?>
